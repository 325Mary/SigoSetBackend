...
const {  crearObligacionesContratista,
    obtenerObligacionesContratista,
    editarObligacionesContratista,
    eliminarObligacionesContratista } = require('../services/obligacionesContratistaService');
const { findOneObligacionContratista} = require('../models/obligacionesContratistaModel')
const controller = {}
