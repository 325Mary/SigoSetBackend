...
CREATE TABLE IF NOT EXISTS `dafv2`.`centro_formacion` (
  ...
  INDEX `fk_Centro_formacion_Regional1_idx` (`idRegional` ASC) VISIBLE,
  INDEX `fk_Centro_formacion_zona1_idx` (`idzona` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`municipio` (
  ...
  INDEX `fk_municipio_departamento1_idx` (`iddepartamento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`sede_formacion` (
  ...
  INDEX `fk_centro_formacion_municipio1_idx` (`idmunicipio` ASC) VISIBLE,
  INDEX `fk_sede_formacion_Centro_formacion1_idx` (`idcentro_formacion` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`certificacion_centrof` (
  ...
  INDEX `fk_certificacion_centrof_centro_formacion1_idx` (`idcentro_formacion` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`contrato_empresav` (
  ...
  INDEX `fk_Contrato_empresav_empresa_vigilancia1_idx` (`idempresa_vigilancia` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`obligaciones_contrato` (
  ...
  INDEX `fk_obligaciones_contrato_Contrato_empresav1_idx` (`idContrato_empresav` ASC) VISIBLE,
  INDEX `fk_obligaciones_contrato_obligaciones_contratista1_idx` (`idobligaciones_contratista` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`detalle_contrato` (
  ...
  INDEX `fk_detalle_contrato_certificacion_centrof1_idx` (`dcertificacion_centrof` ASC) VISIBLE,
  INDEX `fk_detalle_contrato_obligaciones_contrato1_idx` (`idobligaciones_contrato` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`moduloxperfil` (
  ...
  INDEX `fk_moduloxperfil_modulo1_idx` (`idmodulo` ASC) VISIBLE,
  INDEX `fk_moduloxperfil_perfil1_idx` (`idperfil` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`puestosvxcentrof` (
  ...
  INDEX `fk_puestosvxcentrof_centro_formacion1_idx` (`idcentro_formacion` ASC) VISIBLE,
  INDEX `fk_puestosvxcentrof_puestos_vigilancia1_idx` (`idpuesto_vigilancia` ASC) VISIBLE,
  INDEX `fk_puestosvxcentrof_empresa_vigilancia1_idx` (`idempresa_vigilancia` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`puntosvelectronica` (
  ...
  INDEX `fk_puntosvelectronica_centro_formacion1_idx` (`idcentro_formacion` ASC) VISIBLE,
  INDEX `fk_puntosvelectronica_vigilancia_electronica1_idx` (`idvigilancia_electronica` ASC) VISIBLE,
  INDEX `fk_puntosvelectronica_empresa_vigilancia1_idx` (`idempresa_vigilancia` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dafv2`.`usuario` (
  ...
  INDEX `fk_Usuario_Centro_formacion1_idx` (`idcentro_formacion` ASC) VISIBLE,
  INDEX `blackListedTokenId` (`blackListedTokenId` ASC) VISIBLE,
